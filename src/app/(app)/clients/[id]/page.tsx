...
export default function ClientDetailPage({ params }: { params: { id: string } }) {
  ...
  // Filter out hidden articles for display (copy uses current page visible; export fetches full set)
  ...
  const handleExportCSV = async () => {
    ...
    link.download = `${client.name}-${new Date().toISOString().split('T')[0]}.csv`
    link.click()
          ...
          <div className="lg:col-span-2">
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {(visibleArticles.length > 0 || articlesTotal > 0) && (
              ...
              <CardContent className="divide-y divide-gray-100">
                ...
                {!coverageLoading && visibleArticles.length === 0 && (
